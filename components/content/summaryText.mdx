...
I am a versatile and experienced <span style={{ color: lightBlue[700], fontWeight: "bold" }}>software engineer</span> 
...
I am actively looking for my next position in the <span style={{ color: orange[900], fontWeight: "bold" }}>climate</span> or 
<span style={{ color: orange[900], fontWeight: "bold" }}>civic tech</span> space. 
