...
who is looking to use my skills to help any endeavors striving 
to create a more <span style={{ color: purple[500], fontWeight: "bold" }}>sustainable</span> and 
<span style={{ color: purple[500], fontWeight: "bold" }}>caring</span> future. To that end, I am most excited about working 
in the <span style={{ color: orange[800], fontWeight: "bold" }}>climate</span> or 
