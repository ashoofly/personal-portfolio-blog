...
created: '2022-12-05'
tags: ['climate', 'hydrology', 'regenerative', 'regen-ag', 'soil', 'ecology', 'trees', 'microbiology']
---
...
**Some caveats**: I haven't found another reference for "half the rainfall" being attributed to the bacterial precipitation nuclei. Dr. Jehne also notes that this is still frontier stuff. I don't know how much of this we are sure of. If I had commenting capability on this blog, people with more knowledge could comment, but as I don't have that yet, send me a [LinkedIn message](https://www.linkedin.com/in/ayhsu/) please! At some point, I think I will add [Remark42](https://remark42.com/) to this site...
