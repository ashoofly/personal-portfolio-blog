...
Also, the explanation given for the recovery seems like it is still only a hypothesis.

Nevertheless, the complexity of ecology is always surprising us.
In a way, our current models of ecology seem analogous to our attempts
at mapping the human brain. There are so many connections we still don't see,
...
In both cases, we cannot yet fathom how everything connects in a way that makes the world come to life. 
...
Let us walk with gentler feet so that we may learn to listen to what is 
already miraculously here with us - including the coral, the fish, the clams.