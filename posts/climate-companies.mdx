...
## BlocPower
**Solution Area**: <span style={{ color: "#7e57c2", fontWeight: "bold" }}>Electrification</span>  
**Website**: <a href="https://www.blocpower.io/" target="_blank" rel="noopener">www.blocpower.io</a>

Installing affordable heat pumps in residential buildings and historically underserved neighborhoods.  

There's a great [MCJ Collective](https://www.mcjcollective.com/my-climate-journey-podcast/donnel-baird) podcast episode with the founder Donnel Baird.


## Earthshot Labs
**Solution Area**: <span style={{ color: "#7e57c2", fontWeight: "bold" }}>Restoration, Nature-Based Solutions</span>  
...
## Form Energy
**Solution Area**: <span style={{ color: "#7e57c2", fontWeight: "bold" }}>Energy Storage</span>   
...
## Full Harvest
**Solution Area**: <span style={{ color: "#7e57c2", fontWeight: "bold" }}>Food Waste</span>   
...
## Novi Connect
**Solution Area**: <span style={{ color: "#7e57c2", fontWeight: "bold" }}>Supply Chain Transparency</span>   
...
## Regrow
**Solution Area**: <span style={{ color: "#7e57c2", fontWeight: "bold" }}>Regenerative Agriculture</span>  
**Website**: <a href="https://www.regrow.ag/" target="_blank" rel="noopener">www.regrow.ag</a>

MRV (Measure, Verify, Report) software and more for regenerative agriculture.

## Rheaply
**Solution Area**: <span style={{ color: "#7e57c2", fontWeight: "bold" }}>Circular Economy</span>   
...
## SkyTruth
**Solution Area**: <span style={{ color: "#7e57c2", fontWeight: "bold" }}>Earth Satellite Monitoring & Public Accountability</span>   
...
## Sphere
**Solution Area**: <span style={{ color: "#7e57c2", fontWeight: "bold" }}>Climate Investing</span>   
...
## Twelve
**Solution Area**: <span style={{ color: "#7e57c2", fontWeight: "bold" }}>Carbon Transformation</span>  
...
## WeaveGrid
**Solution Area**: <span style={{ color: "#7e57c2", fontWeight: "bold" }}>Electric Grid</span>  
