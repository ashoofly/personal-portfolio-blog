...
He explains concepts really well, you get to practice in the browser by yourself (using their 'scrims'), and by the end of the course, I was ready to start on my own project from scratch. Scrimba also has an active Discord community where you can ask any questions.
...
Afterwards, I wanted to a deeper dive into JavaScript, and found... 
